...
class Country(models.Model):
    name = models.CharField(primary_key=True, max_length=200)
    # continent = models.ManyToManyField('Continent', blank=True, null=True, db_column="continent")


    continent = models.ForeignKey(Continent, models.DO_NOTHING, db_column='continent', blank=True, null=True)
